...
import com.greenapex.dao.UserDao;
...
public class UserServiceImpl implements UserService {
	...
	public User createUser(User user, Set<UserRole> userRoles) {
        ...
        System.out.println(localUser + " LOCAL USER");
        if (localUser != null)
        {
           ...
           rule.setName("ROLE_ADMIN");
            for (UserRole ur : userRoles) 
            {
            	ur.setRole(rule);
            	
            System.out.println(ur.getRole() +"RUNNING TILL HERE");
            	//error
            ...
            System.out.println("before local user");
